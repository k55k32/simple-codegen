...
public class CodeGeneratorImplTest {
    ...
    String targetPath = System.class.getResource("/").getPath() + "/generator-code-test";
    ...
    public void codeGenerator() throws IOException {
        ...
        codeGenerator.codeGenerator("classpath:/code-template", modelDefine, new FreeMarkerTemplateRender());
